...
# 0 in `shots`. If you want to run zero-shot experiments
# only, let this array empty --> `local shots = [];`
local shots = [8, 16, 32];

# In-context examples args
local icl_training_examples = [0, 1];
local icl_inference_examples = [0, 1];
